                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            ...
                            <?php else: ?>
                            <img src="Electricks/Electricks-shop/uploads/Construction-Sand.jpeg">
                            <?php endif; ?>
                        ...
                        <div class="carousel-item">
                            ...
                            <?php else: ?>
                            <img src="Electricks/Electricks-shop/uploads/ironrods.jpeg">
                            <?php endif; ?>
                            <div class="carousel-caption d-none d-md-block">
                                <h5><?php echo $res['prod_name']; ?></h5>
                            </div>
                        ...
                        <div class="carousel-item">
                            ...
                            <?php else: ?>
                            <img src="Electricks/Electricks-shop/uploads/plywood.jpeg">
                            <?php endif; ?>
                            <div class="carousel-caption d-none d-md-block">
                                <h5><?php echo $res['prod_name']; ?></h5>
                            </div>
