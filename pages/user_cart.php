...
<body class="index-page sidebar-collapse">
    <div class="wrapper"><br>
      ...
      <?php 
        ...
        $query3=mysqli_query($dbconn,"SELECT * FROM order_details WHERE user_id='$user_id' AND order_id=''") or die (mysqli_error($dbconn));
      ...
      <table class="table table-condensed table-bordered">
              <thead>
                <tr>
                  ...
                  <th width="100">Price(GHC)</th>
                  <th width="100">Total(GHC)</th>
          ...
          ?>
            ...
            ?>
                ...
                <!-- <a href="payment.php"><button class="btn btn-block btn-lg btn-primary">Check Out</button></a> -->
                      ...
                      <div class="modal-content">
                        ...
                        <form id="paymentForm">
                          ...
                          <div class="modal-footer">
                            ...
                            <div class="form-group">
                              <a><button type="submit" name="submit" class="btn btn-success btn-round" onclick="payWithPaystack(event)"><i class="now-ui-icons shopping_delivery-fast"></i> Pay</button></a>
                            </div>
                          </div>
                        </form>
                      </div>
...
<footer class="footer" data-background-color="black">
            <div class="container">
                ...
                <div class="copyright">
                    ...
                    </script>, Designed and Coded by Abigail Kesse.
                </div>
            </div>
        </footer>
    </div>
