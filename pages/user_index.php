    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="user_index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by Abigail Kesse." data-placement="bottom" target="">
                    Construct
                </a>
            ...
            <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/ironman.jpg');">
                ...
                <div class="container">
                    <div class="content-center brand">
                        ...
                        <br><br>
                        <h3>Building materials that includes, cement, iron rods, sand etc.</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <nav>
                    <ul>
						...
						<li>Brought To You By <a href="https://code-projects.org/">Kesse</a></li>
                    </ul>
                </nav>
                <div class="copyright">
                    &copy;
