    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="../index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by Abigail Kesse." data-placement="bottom">
                    E-Commerce Website
                </a>
        ...
        <footer class="footer">
            <div class="container">
                <div class="copyright">
                    ...
                    </script>,</a> Designed and Coded by Abigail Kesse.
                </div>
            </div>
        </footer>
    </div>
