...
$query = "INSERT INTO order (user_id, track_num, firstname, middlename, lastname, email, contact, shipping_add, order_date, status, totalprice, tax) 
 ...
 mysqli_query($dbconn,"UPDATE order_details SET order_id=order_id+1 WHERE user_id='$user_id' AND order_id=''")or die(mysqli_error($dbconn));
...
?>
        ...
        <hr color="orange"> 
        <br><br>
        <h3>Payment type will be <b>eleectronically</b></h3>
